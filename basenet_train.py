...
def train():
    #1. Get mobile net
    yolo_base_net = nets_factory.get_network(FLAGS.net_chose)
    yolo_basenet_obj = yolo_base_net.YOLO_Base()
    ...
    y = yolo_basenet_obj.base_net(x, num_classes=FLAGS.num_classes)
